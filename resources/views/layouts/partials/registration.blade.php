            ...
            <div class="register-width">
                <div class="form-group col-12">
                    <div class="row">
                        ...
                        <div class="col-md-8"><input type="text" class="form-control" required="required"></div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                ...
                <div class="form-group col-12">
                    <div class="row">
                        ...
                        <div class="col-md-8"><input type="email" class="form-control" required="required"></div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                        <div class="col-md-4"><label><b>Telefoonnummer *</b></label></div>
                        <div class="col-md-8"><input type="tel" class="form-control" required="required"></div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
                ...
                <div class="form-group col-12">
                    <div class="row">
                        ...
                        <div class="col-md-8"><input type="number" class="form-control" required="required"></div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <div class="row">
