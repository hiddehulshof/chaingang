                        ...
                        <div class="field">
                            <div class="control">
                                <select class="button filter" name="category">
                                    ...
                                    <option class="dropdown-item custom-item" value="{{$category->id}}">
                                        {{ $category->Naam }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="field">
                            <div class="control">
                                <select class="button filter" name="brand">
                                    ...
                                    <option class="dropdown-item custom-item" value="{{$brand}}">{{ $brand}}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="field">
                            <div class="control">
                                <select class="button filter" name="gears">
                                    ...
                                    <option class="dropdown-item custom-item" value="0">Aantal versnellingen
                                    </option>
